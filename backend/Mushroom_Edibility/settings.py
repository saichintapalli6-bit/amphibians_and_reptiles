"""
Django settings for Mushroom_Edibility project.
...
SECRET_KEY = 'django-insecure-#k5df70hm7r%_^4$1sfkh631aiz%+&qh%!rh=2d(sd-52l^@#@'
...
ROOT_URLCONF = 'Mushroom_Edibility.urls'
...
WSGI_APPLICATION = 'Mushroom_Edibility.wsgi.application'
